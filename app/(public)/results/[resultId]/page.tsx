...
const ResultPage = async ({ params, searchParams }: Props) => {
  ...
  return (
    <>
      <section className="bg-[#FBF9F9] rounded-[32px] container mx-auto py-16  px-8 text-center">
      ...
      <section className="flex flex-col py-10 items-center gap-6 w-full max-w-2xl mx-auto">
        {newScore && (
        ...
        <div className="text-center w-full">
          <p>
            {newScore ? "First Time Played Result" : "Here are your results"}
          </p>
